<div class="container-fluid">
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        <div class="flex-grow-1">
            <h4 class="fs-18 fw-semibold m-0">Web settings</h4>
        </div>
    </div>
    <div class="row py-3">
        ...
        <div class="col-md-12">
            <!-- Nav tabs -->
                <ul class="nav nav-pills" role="tablist">
                    ...
                    <a href="#basic" aria-controls="basic" role="tab" data-bs-toggle="tab" class="nav-link active">Basic</a>
                </li>
                    <li role="presentation" class="nav-item">
                    <a href="#api" aria-controls="api" role="tab" data-bs-toggle="tab" class="nav-link">Third Party APIs</a></li>
                </ul>
                                ...
                                <?php foreach ($website as $web): ?>
                                    <form id="webBasicForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/website/updatebasic" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-offset-1 col-md-4">
                                                ...
                                                <div class="form-group py-1 label-floating">
                                                    <p class="image_select_text"><?php echo $this->lang->line('dash_gpanel_sfavicon'); ?></p>
                                            ...
                                            <div class="col-md-offset-1 col-md-4">
                                                ...
                                                <div class="form-group py-1 label-floating">
                                                    <p class="image_select_text"><?php echo $this->lang->line('dash_gpanel_slogo'); ?></p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group py-1 label-floating">
                                                    <label class="form-label"><?php echo $this->lang->line('dash_gpanel_webtitle'); ?> (*)</label>
                                                    <input id="title" name="title" type="text" class="form-control" value="<?php echo $web->title; ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group py-1 label-floating">
                                                    <label class="form-label"><?php echo $this->lang->line('dash_gpanel_webtag'); ?> (*)</label>
                                                    <input id="tag" name="tag" type="text" class="form-control" value="<?php echo $web->tag; ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group py-1 label-floating">
                                                    <label class="form-label"><?php echo $this->lang->line('dash_gpanel_webmap'); ?></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group py-1 label-floating">
                                                    <label class="form-label"><?php echo $this->lang->line('dash_gpanel_adminemail'); ?></label>
                                                    <input id="email" name="email" type="text" class="form-control" value="<?php echo $web->email; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group py-1 label-floating">
                                                    <label class="form-label"><?php echo $this->lang->line('dash_gpanel_themecolor'); ?></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group py-1 label-floating">
                                                    <label class="form-label"><?php echo $this->lang->line('dash_gpanel_webchurchtime'); ?></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group py-1 label-floating">
                                                    <label class="form-label"><?php echo $this->lang->line('dash_gpanel_webaboutus'); ?></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group py-1 label-floating">
                                                    <label class="form-label"><?php echo $this->lang->line('dash_gpanel_webcontact'); ?></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group py-1 label-floating">
                                                    <label class="form-label"><?php echo $this->lang->line('dash_gpanel_donationtext'); ?></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group py-1 label-floating">
                                                    <label class="form-label"><?php echo $this->lang->line('dash_gpanel_webcopyright'); ?></label>
                                    ...
                                    <?php foreach ($website as $web): ?>
                                        <form id="webApiForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/website/updateapis" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_googlemapapi'); ?></label>
                                                        <input id="map" name="mapapi" type="text" class="form-control" value="<?php echo $web->mapapi; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_fbappid'); ?></label>
                                                        <input name="fbappid" type="text" class="form-control" value="<?php echo $web->fbappid; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_selectsmsapi'); ?></label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_mailgun_api'); ?></label>
                                                        <input name="mailgun_api" type="text" class="form-control" value="<?php echo $web->mailgun_api; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_mailgun_from'); ?></label>
                                                        <input name="mailgun_from" type="text" class="form-control" value="<?php echo $web->mailgun_from; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_mailgun_domain'); ?></label>
                                            ...
                                            <div class="row nexmoDiv" style="display:none">
                                                <div class="col-md-4">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_nexmo_api'); ?></label>
                                                        <input name="nexmo_api" type="text" class="form-control" value="<?php echo $web->nexmo_api; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_nexmo_secret'); ?></label>
                                                        <input name="nexmo_secret" type="text" class="form-control" value="<?php echo $web->nexmo_secret; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_nexmo_from'); ?></label>
                                            ...
                                            <div class="row twilioDiv" style="display:none">
                                                <div class="col-md-4">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_twilio_sid'); ?></label>
                                                        <input name="twilio_sid" type="text" class="form-control" value="<?php echo $web->twilio_sid; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_twilio_token'); ?></label>
                                                        <input name="twilio_token" type="text" class="form-control" value="<?php echo $web->twilio_token; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_twilio_sender'); ?></label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_paypal_client_id'); ?></label>
                                                        <input name="paypal_client_id" type="text" class="form-control" value="<?php echo $web->paypal_client_id; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_paypal_secret'); ?></label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_stripe_secret'); ?></label>
                                                        <input name="stripe_secret" type="text" class="form-control" value="<?php echo $web->stripe_secret; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_stripe_apikey'); ?></label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group py-1 label-floating">
                                                        <label class="form-label"><?php echo $this->lang->line('dash_gpanel_paystack_secret'); ?></label>
                                            ...
                                            <button id="webApiSubmit" type="submit" class="btn btn-primary pull-right"><?php echo $this->lang->line('dash_gpanel_update_now'); ?></button>
                                            <div class="clearfix"></div>
                                        </form>
                                    <?php endforeach; ?>
                                </div>
