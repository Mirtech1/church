<div class="container-fluid">
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        <div class="flex-grow-1">
            <h4 class="fs-18 fw-semibold m-0">Section</h4>
        </div>
    </div>
    <div class="row">	                    
        <div class="#">
                        ...
                        <tbody>
                            ...
                            foreach ($pages as $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url(); ?>dashboard/website/pageedit/<?php echo $row->pageid; ?>" class="btn btn-warning"><?php echo $this->lang->line('dash_gpanel_edit'); ?></a>
                                        <a href="<?php echo base_url(); ?>dashboard/website/pagedelete/<?php echo $row->pageid; ?>" class="btn btn-danger delete"><?php echo $this->lang->line('dash_gpanel_delete'); ?></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
