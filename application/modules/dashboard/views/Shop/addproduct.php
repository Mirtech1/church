        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" data-background-color="purple">
                    <h4 class="title"><?php echo $this->lang->line('dash_addproduct_panel_title'); ?></h4>
                ...
                <div class="card-body">
                    ...
                    <form id="addProductForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/shop/addnewproduct" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group py-1 label-floating">
                                    <p class="image_select_text"><?php echo $this->lang->line('dash_gpanel_ppp'); ?></p>
                                    <input type="file" onchange="seminarbanner()" name="productimage" id="productimage" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4"></div>
                        </div>
                        ...
                        <button id="addProductFormSubmit" type="submit" class="btn btn-primary pull-right mt-2"><?php echo $this->lang->line('dash_addproduct_panel_title'); ?></button>
