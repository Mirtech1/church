<div class="container-fluid">
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        <div class="flex-grow-1">
            <h4 class="fs-18 fw-semibold m-0">Add Pastor</h4>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="title"><?php echo $this->lang->line('dash_addpastor_panel_title'); ?></h4>
                ...
                <div class="card-body">
                    ...
                    <form id="addPastorForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/pastor/addnewpastor" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <button id="addPastorSubmit" type="submit" class="btn btn-primary pull-right"><?php echo $this->lang->line('dash_addpastor_panel_title'); ?></button>
