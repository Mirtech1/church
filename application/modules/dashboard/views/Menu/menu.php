        ...
        <div class="#">
            <div class="card">
                <div class="card-header" data-background-color="purple">
                    <h4 class="title"><?php echo $this->lang->line('dash_addmenu_panel_title'); ?></h4>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group py-1 label-floating">
                                    <label class="form-label"><?php echo $this->lang->line('dash_gpanel_menuname'); ?> (*)</label>
                                    <input id="menuname" name="menuname" type="text" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group py-1 label-floating">
                                    <label class="form-label"><?php echo $this->lang->line('dash_gpanel_menuparent'); ?></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group py-1 label-floating">
                                    <label class="form-label"><?php echo $this->lang->line('dash_gpanel_menupage'); ?> Menu Page</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group py-1 label-floating">
                                    <label class="form-label"><?php echo $this->lang->line('dash_gpanel_menulink'); ?></label>
                                    <input id="menulink" name="menulink" type="text" class="form-control" value="<?php echo base_url();?>">
                                </div>
                            </div>
                        </div>
                        <button id="menuAddSubmit" type="submit" class="btn btn-primary pull-right"> <?php echo $this->lang->line('dash_addmenu_panel_title'); ?></button>
            ...
            <div class="card gusers">
                <div class="card-header" data-background-color="purple">
                    <h4 class="title"><?php echo $this->lang->line('dash_allmenus_panel_title'); ?> ( <?php
                        $this->db->from('menu');
                        echo $this->db->count_all_results();
                        ?> ) </h4>

                    <h4 class="title"><a  data-toggle="modal" data-target="#updateMenuUrl" href="<?php echo base_url();?>dashboard/menu/urlupdate">Update Menu URL</a></h4>
                    <p class="category"><?php echo $this->lang->line('dash_gpanel_newmenu'); ?> <?php echo getCreateDate('menuid','menu'); ?></p>
                </div>
                <div class="card-body table-responsive">
                    <table class="table  table table-striped table-bordered dt-responsive nowrap" id="datatable-buttons">
                            ...
                            foreach ($parentmenu as $row) {
                                ...
                                <tr data-id="<?php echo $row->menuid; ?>" style="color: rgba(33, 33, 33, 0.70); font-weight: bold" class="parent-menu">
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td>
                                        <a href="<?php echo base_url(); ?>dashboard/menu/edit/<?php echo $row->menuid; ?>" class="btn btn-warning"> <?php echo $this->lang->line('dash_gpanel_edit'); ?></a>
                                        <a href="<?php echo base_url(); ?>dashboard/menu/delete/<?php echo $row->menuid; ?>" class="btn btn-danger delete"><?php echo $this->lang->line('dash_gpanel_delete'); ?></a>
                                    </td>
                                </tr>
                                ...
                                foreach ($cmquery->result() as $cm) {
                                    ...
                                    <tr data-id="<?php echo $cm->menuid . "," . $row->menuid . "," . $j; ?>" class="child-menu">
                                        ...
                                        <td><?php
                                            ...
                                            ?></td>
                                        <td>
                                            <a href="<?php echo base_url(); ?>dashboard/menu/edit/<?php echo $cm->menuid; ?>" class="btn btn-warning"><?php echo $this->lang->line('dash_gpanel_edit'); ?></a>
                                            <a href="<?php echo base_url(); ?>dashboard/menu/delete/<?php echo $cm->menuid; ?>" class="btn btn-danger delete"><?php echo $this->lang->line('dash_gpanel_delete'); ?></a>
                                        </td>
                                    </tr>
                ...
                <div class="modal-body">
                        <form class="form-horizontal" action="<?php echo base_url(); ?>dashboard/menu/updateurl" method="post" enctype="multipart/form-data">
                            <div class="col-md-12">
                                ...
                                <button type="submit" class="btn btn-primary pull-right"><?php echo $this->lang->line('dash_gpanel_update_now'); ?></button>
                                <div class="clearfix"></div>
                            </div>
                        </form>
                </div>
