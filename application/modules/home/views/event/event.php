                        ...
                        <div class="col-lg-4">
                            <div class="thumb">
                                <a href="<?php echo base_url();?>home/event/view/<?php echo $event->eventid;?>">
                                    <img class="rounded mt-sm-0 w-100" src="<?php echo base_url();?>assets/assets/images/event/feature/<?php echo $event->eventimage;?>" alt="Blessed" data-aos="fade-up">
                                </a>
                            </div>
                            <div class="position-relative mb-5 d-flex justify-content-center event-card-1 hover-up">
                                <div class="content-event rounded">
                                    <h4 class="mt-4 fw-medium"><a href="<?php echo base_url();?>home/event/view/<?php echo $event->eventid;?>"><?php echo $event->eventtitle;?></a></h4>
                                    <p class="content-p pb-4" data-aos="fade-up"></p>
                                    <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between">
                                        <div class="times">
                                            <p class="time fs-8 mb-1">
                                                <i class="size-12" data-feather="clock"></i>
                                                <span><?php echo $event->eventtime;?></span>
                                            </p>
                                            <p class="location fs-8">
                                                <i class="size-12" data-feather="map-pin"></i>
                                                <span><?php echo $event->eventlocation;?></span>
                                            </p>
                                        </div>
                                        <div class="button">
                                            <a href="<?php echo base_url();?>home/event/view/<?php echo $event->eventid;?>" class="d-inline-flex rounded-5 tc-btn-md fs-8 text-center">
