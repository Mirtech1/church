                        ...
                        <div class="col-lg-4 col-md-6 mb-5">
                            <div class="card-blog-1 rounded-2 overflow-hidden bg-white shadow-1 shine-animate-item hover-up">
                                ...
                                <div class="card-body p-4">
                                    <h5 class="font-body text-dark fs-5 lh-base"><a href="<?php echo base_url();?>home/prayer/view/<?php echo $prayer->prayerid;?>" class=""><?php echo character_limiter($prayer->prayertitle, 20);?></a></h5>
                                    <div class="meta-1 fs-7 mb-3"></div>
                                    <p class="fs-7 mb-4 text-dark"><?php echo word_limiter($prayer->prayerdescription, 50);?></p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <!-- <div class="view">
                                            <i class="size-14" data-feather="eye"></i>
                                            <span class="text-dark fs-7">27 views</span>
                                        </div> -->
                                        <a href="<?php echo base_url();?>home/prayer/view/<?php echo $prayer->prayerid;?>" class="text-decoration-underline fs-7">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
