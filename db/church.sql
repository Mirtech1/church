...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2024 at 06:10 PM
...
CREATE TABLE `assets` (
  ...
  `assetsdate` varchar(255) NOT NULL,
  `assetsitem` varchar(255) NOT NULL,
  `assetsamount` varchar(255) NOT NULL,
  `assetsverifiedby` varchar(255) NOT NULL,
  `assetsnote` varchar(255) NOT NULL,
  `assetsmonth` varchar(255) NOT NULL,
  `assetsyear` varchar(255) NOT NULL,
...
CREATE TABLE `chorus` (
  ...
  `marriagedate` varchar(50) NOT NULL,
...
CREATE TABLE `department` (
  ...
  `departmentcontact` varchar(255) NOT NULL,
  `departmentarea` varchar(255) NOT NULL,
...
CREATE TABLE `donation` (
  ...
  `donationmonth` varchar(255) NOT NULL,
  `donationyear` varchar(255) NOT NULL,
  `donationamount` varchar(255) NOT NULL,
  `donationsource` varchar(255) NOT NULL,
  `donationby` varchar(255) NOT NULL,
  `donationinfo` varchar(255) NOT NULL,
  `donationreceivedby` varchar(255) NOT NULL,
  `donationnote` varchar(255) NOT NULL,
  `cdate` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `event` (
  ...
  `eventstartdate` varchar(100) DEFAULT NULL,
  `eventenddate` varchar(100) NOT NULL,
  `cdate` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `family` (
  ...
  `familyleader` varchar(255) NOT NULL,
  `memberquantity` varchar(255) NOT NULL,
  `familycontact` varchar(255) NOT NULL,
  `address` varchar(255) NOT NULL,
  `city` varchar(255) NOT NULL,
  `country` varchar(255) NOT NULL,
  `postal` varchar(255) NOT NULL,
...
CREATE TABLE `funds` (
  ...
  `fundsdate` varchar(255) NOT NULL,
  `fundsmonth` varchar(255) NOT NULL,
  `fundsyear` varchar(255) NOT NULL,
  `fundsamount` varchar(255) NOT NULL,
  `fundstype` varchar(255) NOT NULL,
  `receivedby` varchar(255) NOT NULL,
  `fundssource` varchar(255) NOT NULL,
  `fundsnote` varchar(255) NOT NULL,
  `fundsbalance` varchar(255) NOT NULL,
  `cdate` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `member` (
  ...
  `socialstatus` varchar(255) NOT NULL,
...
CREATE TABLE `menu` (
  ...
  `menupageid` varchar(255) NOT NULL,
  `menuname` varchar(255) NOT NULL,
  `menuparentid` varchar(255) NOT NULL,
...
(8, 5, 4, '', 'Member', '5', 'http://localhost/church/home/member', '25 June 2020'),
(10, 5, 5, '', 'Clan', '5', 'http://localhost/church/home/clan', '25 June 2020'),
(11, 5, 7, '', 'Student', '5', 'http://localhost/church/home/school', '25 June 2020'),
(12, 5, 6, '', 'Staff', '5', 'http://localhost/church/home/staff', '25 June 2020'),
(35, 0, 0, '', 'Home', '', 'http://localhost/church/', '25 June 2020'),
(36, 5, 2, 'ourpastor', 'Committee', '5', 'http://localhost/church/home/committee/', '14 February 2024'),
(37, 5, 3, '', 'Pastor', '5', 'http://localhost/church/home/pastor', '25 June 2020'),
(38, 47, 10, '', 'Events', '47', 'http://localhost/church/home/event', '25 June 2020'),
(39, 47, 11, '', 'Sermon', '47', 'http://localhost/church/home/sermon/view/2', '12 February 2024'),
(40, 47, 13, '', 'Prayer', '47', 'http://localhost/church/home/prayer', '25 June 2020'),
(41, 47, 9, '', 'Notice', '47', 'http://localhost/church/home/notice', '25 June 2020'),
(42, 47, 14, '', 'Speech', '47', 'http://localhost/church/home/speech', '25 June 2020'),
(43, 47, 12, '', 'Seminar', '47', 'http://localhost/church/home/seminar', '25 June 2020'),
(45, 16, 0, '', 'Gallery', '', 'http://localhost/church/home/gallery', '25 June 2020'),
(46, 17, 0, '', 'Blog', '', 'http://localhost/church/home/blog', '25 June 2020'),
(47, 8, 0, '', 'Pages', '', '#', '25 June 2020'),
(48, 15, 0, '', 'Shop', '', 'http://localhost/church/home/shop', '25 June 2020');
...
CREATE TABLE `prayer` (
  ...
  `prayertitle` varchar(255) NOT NULL,
...
INSERT INTO `prayer` (`prayerid`, `prayertitle`, `prayerdescription`, `cdate`, `userID`) VALUES
(10, 'Prayer For Mr. John', 'Lorem Ipsum has been the industry\'s standard dumm', '29 June 2017', NULL),
(13, 'Prayer For Mr. John', 'Lorem Ipsum has been the industry\'s standard dumm', '29 June 2017', NULL),
(14, 'Prayer For Mr. John', 'Lorem Ipsum has been the industry\'s standard dumm', '29 June 2017', NULL),
(15, 'Prayer For Mr. John', 'Lorem Ipsum has been the industry\'s standard dumm', '29 June 2017', NULL);
...
CREATE TABLE `role` (
  ...
  `sermon` varchar(10) DEFAULT NULL,
  `event` varchar(10) DEFAULT NULL,
  `prayer` varchar(10) DEFAULT NULL,
  `notice` varchar(10) DEFAULT NULL,
  `speech` varchar(10) DEFAULT NULL,
  `family` varchar(10) DEFAULT NULL,
  `department` varchar(10) DEFAULT NULL,
  `committee` varchar(10) DEFAULT NULL,
  `member` varchar(10) DEFAULT NULL,
  `pastor` varchar(10) DEFAULT NULL,
  `clans` varchar(10) DEFAULT NULL,
  `chorus` varchar(10) DEFAULT NULL,
  `staffs` varchar(10) DEFAULT NULL,
  `school` varchar(10) DEFAULT NULL,
  `user` varchar(10) DEFAULT NULL,
  `seminar` varchar(10) DEFAULT NULL,
  `attendance` varchar(10) DEFAULT NULL,
  `communicaction` varchar(10) DEFAULT NULL,
  `blog` varchar(10) DEFAULT NULL,
  `shop` varchar(10) DEFAULT NULL,
  `import` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `section` (
  ...
  `sectiononoff` varchar(50) DEFAULT NULL,
...
CREATE TABLE `seminar` (
  ...
  `seminarbanner` varchar(255) NOT NULL,
  `seminartitle` varchar(255) NOT NULL,
  `seminarslogan` varchar(255) NOT NULL,
  `seminardescription` text NOT NULL,
  `seminarstart` varchar(255) NOT NULL,
  `seminarend` varchar(255) NOT NULL,
  `seminarlocation` varchar(255) NOT NULL,
  `cdate` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `seminarregistration` (
  ...
  `selectedseminarid` varchar(255) NOT NULL,
  `profileimage` varchar(255) NOT NULL,
  `fname` varchar(255) NOT NULL,
  `lname` varchar(255) NOT NULL,
  `gender` varchar(255) NOT NULL,
  ...
  `churchpastor` varchar(255) NOT NULL,
  `guardian` varchar(255) NOT NULL,
  `guardiancontact` varchar(255) NOT NULL,
  `nationality` varchar(255) NOT NULL,
  `paymentgateway` varchar(255) NOT NULL,
  `paymentgatewayinfo` varchar(255) NOT NULL,
  `paymentsenderinfo` varchar(255) NOT NULL,
  `address` varchar(255) NOT NULL,
  `city` varchar(255) NOT NULL,
  `country` varchar(255) NOT NULL,
  `postal` varchar(255) NOT NULL,
...
(10, 0, '20240223_060809_383878.jpeg', '23 February 2024'),
(11, 0, '20240223_060809_287498.jpg', '23 February 2024'),
(12, 0, '20240223_060809_368911.jpg', '23 February 2024'),
(13, 0, '20240223_060809_238727.jpg', '23 February 2024'),
(14, 0, '20240223_060810_994740.jpg', '23 February 2024');
...
CREATE TABLE `users` (
  ...
  `mediaIdentifier` varchar(255) NOT NULL,
  `position` varchar(255) NOT NULL,
  `bpdate` varchar(255) NOT NULL,
  `blood` varchar(255) NOT NULL,
  `dob` varchar(255) NOT NULL,
...
CREATE TABLE `websitebasic` (
  ...
  `mapapi` varchar(255) NOT NULL,
  `fbappid` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `color` varchar(255) NOT NULL,
  `churchtime` text NOT NULL,
  `about` varchar(255) NOT NULL,
  ...
  `donationtext` text DEFAULT NULL,
  `verify` varchar(255) DEFAULT NULL,
  `mailgun_api` varchar(100) DEFAULT NULL,
  `mailgun_from` varchar(100) DEFAULT NULL,
  `mailgun_domain` varchar(100) DEFAULT NULL,
  `nexmo_api` varchar(100) DEFAULT NULL,
  `nexmo_secret` varchar(100) DEFAULT NULL,
  `nexmo_from` varchar(100) DEFAULT NULL,
  `paypal_client_id` varchar(100) DEFAULT NULL,
  `paypal_secret` varchar(100) DEFAULT NULL,
  `stripe_apikey` varchar(100) DEFAULT NULL,
  `stripe_secret` varchar(100) DEFAULT NULL,
  `twilio_sid` varchar(100) DEFAULT NULL,
  `twilio_token` varchar(100) DEFAULT NULL,
  `twilio_sender` varchar(100) DEFAULT NULL,
  `smsapi` int(11) DEFAULT NULL,
  `licUsername` varchar(255) DEFAULT NULL,
  `licPurchaseDate` varchar(255) DEFAULT NULL,
  `paystack` varchar(255) DEFAULT NULL,
...
--
ALTER TABLE `slider`
  MODIFY `sliderid` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
